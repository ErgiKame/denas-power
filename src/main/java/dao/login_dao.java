...
public class login_dao extends DAO {
	...
	public String get_pass() throws SQLException {
		String pass = "";
		String sql = "SELECT password FROM denas_power.perdoruesit  where userid = '"+Utils.idP+"' ";
	...
	public boolean check_user_and_pass(String user,String pass) {
		String sql = "SELECT username, password, userid , rights, name from denas_power.perdoruesit  WHERE username = ? and password = ? ";
	...
	public void update_password(perdoruesit p) throws SQLException {
		String update_password = "update denas_power.perdoruesit set password = ? where userid = ?";
